...
namespace Charites.Windows.Mvc
{
    ...
    class AvaloniaControllerSpec_AttachingAndDetachingController : FixtureSteppable
    {
        ...
        TestAvaloniaControllers.TestAvaloniaController Controller { get; set; }

        bool AttachedToLogicalTreeEventHandled { get; set; }
        bool ChangedEventHandled { get; set; }
        TestAvaloniaControllers.TestAvaloniaControllerBase[] Controllers { get; set; }
        bool[] AttachedToLogicalTreeEventsHandled { get; set; }
        bool[] ChangedEventsHandled { get; set; }
